...
\label{sec:IoTNature}
    ...
    The global format of such a JSON needs the ability to transport any type of message. Therefore the listing \ref{lst:jsonEnvelope} represents such a message.
