...
\label{sec:SmartContracts}
    ...
    % some papers from 'papers 2' folder can be added here

% \section{Proof of Work and Proof of Stake}
% \label{sec:PoWandPoS}

    % some other papers from 'papers 2' folder
